const MainContent = () => {
  return (
    <div>
      ...
      avoids a pain that produces no resultant pleasure?" "But I must explain to
      ...
      pain that produces no resultant pleasure?" "But I must explain to you how
      ...
      pleasure?"
      <div className="bg-amber-100 min-h-[800px]"></div>
    </div>
  );
};
